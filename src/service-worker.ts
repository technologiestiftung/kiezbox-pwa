...
self.addEventListener('install', (event) => {
	async function addFilesToCache() {
		...
		// adding all ASSETS into the cache
		// later we can specify what files we want to cache
...
// Anfragen abfangen und Antworten geben:
// Der Service Worker kann Netzwerk-Anfragen abfangen und entscheiden, ob er die Antwort aus dem Cache oder dem Netzwerk holt.
